...
namespace HR_Management.Api.Controllers
{
    ...
    public class LeaveRequestsController : ControllerBase
    {
        ...
        {
            var leaveRequets = await _mediator.Send(new GetLeaveRequestListRequest());
        ...
        [HttpPost]
        public async Task<ActionResult<BaseCommandResponse>> Post([FromBody] CreateLeaveRequestDto createLeaveRequest)
        {
            var command = new CreateLeaveRequestCommand { CreateLeaveRequestDto = createLeaveRequest };
